...
#for x in range(3):
  ...
  print '====================================== Script 1 ============================================='
  print 'product Number:\t ' + str(x) + " / " + str(len(upcs1))
  print '----------------------------'

  products = api.query(upcs1[x], product_code_is_asin=False, offers=100, stats=90, history=0, rating=1)
  print '\n'
  ...
  del csv
  import csv
  with open('output1.csv', "a") as output_file:
